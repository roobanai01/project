...
def login():
    ...
    if(a=="boss") & (b=="123"):
        boss()
    elif(a=="manager") & (b=="456"):
        manager()
    elif(a=="employee") & (b=="789"):
        employee()
    else:
...
def boss():
    ...
    tab_parent.add(tab1,text="Working Space")
    tab_parent.add(tab2,text="Preview Space")
...
def manager():
    ...
    def delete():
        f="You don't have the access to do this option..."
        labeloutput6.config(text=f)
